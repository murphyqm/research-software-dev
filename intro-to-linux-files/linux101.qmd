...
format:
  revealjs: 
    ...
    footer: "Maeve Murphy Quinlan | Linux 101 | [Back to main site](https://murphyqm.github.io/research-software-dev/)"
---
...
![](excel-gui.png){fig-align="center" fig-alt="A screenshot of Excel."}
...
![](code_button.png){fig-align="center" fig-alt="A green button with the word 'Code'."}
...
::: {#second-column}
![](codespaces-2.png){fig-align="center" fig-alt="A green button with the word 'Code'."}
:::
